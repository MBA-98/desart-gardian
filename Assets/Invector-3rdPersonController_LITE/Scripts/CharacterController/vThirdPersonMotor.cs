...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : MonoBehaviour
    {
        ...
        /// <summary>Project gameplay: true while sprinting on ground with movement input (for sprint fatigue, etc.).</summary>
        public bool IsSprintingOnGroundWithMoveInput =>
            isSprinting && isGrounded && input.sqrMagnitude > 0.01f;
